                        ...
                        <div className="lg:flex gap-32">
                            <div className="space-y-7">
                                ...
                                <div className="flex">
                                    ...
                                    <p className="text-gray-500">England</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-7">
                                <div className="flex">
                                    ...
                                    <p className="text-gray-500">31 Greville Road</p>
                                </div>
                                ...
                                <div className="flex">
                                    ...
                                    <p className="text-gray-500">GU1 3LK</p>
                                </div>
                        ...
                        <CardHeader>
                            <div className="flex items-center gap-3">
                                <CardTitle>2 Step Verification</CardTitle>
                                    {true ?<Badge className="space-x-2 text-black bg-green-600">
                                        <VerifiedIcon/>
                                        <span>Enabled</span>
                                    </Badge>: 
